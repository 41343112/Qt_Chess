...
- **線上對戰模式** 🆕：
  - **中繼伺服器模式**：跨網域連線，只需4位數字房號即可連線！🌐
  - **直接連接模式**：傳統P2P連接，適合同網域使用
  - **超簡單操作**：創建房間後取得房號，朋友輸入房號即可加入
  - **跨網域支援**：使用中繼伺服器無需設定路由器端口轉發
  - **自動填入功能**：支援剪貼簿貼上，自動解析連線資訊
  - **友善介面**：適合不懂電腦的使用者
  ...
  - 📖 [中繼伺服器設定指南](docs/RELAY_SERVER_SETUP.md) - 設定跨網域連線
