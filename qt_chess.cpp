...
void Qt_Chess::setupUI() {
    ...
    QVBoxLayout*  timeControlPanelLayout = new QVBoxLayout(m_timeControlPanel);
    timeControlPanelLayout->setContentsMargins(0, 0, 0, 0);
    setupTimeControlUI(timeControlPanelLayout);
